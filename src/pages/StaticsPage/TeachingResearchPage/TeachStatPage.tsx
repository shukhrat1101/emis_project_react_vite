...
const TeachStatPage: React.FC = () => {
    ...
    const fetchList = async () => {
        try {
            setLoading(true);
            const res = await researchTeachGetService.listTeaching({
                page,
                page_size: pageSize,
                search,
    ...
    return (
        <div className="teach-year-page">
            <div className="header">
                <h2 className="title">O‘quvlar ro‘yxati</h2>
                <div
